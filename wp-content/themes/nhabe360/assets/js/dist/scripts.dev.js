...
$(document).ready(function () {
  ...
  $('#list-carousel').owlCarousel((_$$owlCarousel = {
    margin: 0,
    loop: true,
    autoplay: false,
    lazyLoad: true,
  ...
  $('#list-carousel-thumb').owlCarousel((_$$owlCarousel2 = {
    margin: 10,
    dots: false,
    loop: true,
    autoplay: false,
  ...
  }, _defineProperty(_$$owlCarousel2, "loop", true), _defineProperty(_$$owlCarousel2, "responsive", {
    300: {
      items: 3
    },
    900: {
...
$('[data-toggle="tooltip"]').tooltip(); //CHECKBOX
